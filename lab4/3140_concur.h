...
These helper functions were written on our own

------------------------------------------------------------------------*/
/* Enqueues a new process onto the ready queue of processes */
void enqueue( process_t* new_process);

/* Dequeues a process from the ready queue of processes */
